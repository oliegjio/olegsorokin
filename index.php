...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/bower_components/slick-carousel/slick/slick.css" media="screen" title="no title" charset="utf-8">
    <link rel="stylesheet" href="/bower_components/slick-carousel/slick/slick-theme.css" media="screen" title="no title" charset="utf-8">
    ...
    <!-- <div class="welcome-section parallax-container parallax-window" data-parallax="scroll" data-image-src="./../img/background.jpg">
      <div class="welcome-section-shadow">
        <div class="container">
          ...
          <h1>Web Developer</h1>
          <p>You need amazing web developer? Well, you found it!</p>
          <a class="hire-me" href="#">Hire Me</a>
        </div>
      </div>
    </div> -->
